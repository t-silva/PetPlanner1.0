...
import com.petplanner.petplanner.DAO.AguaDAO;
import com.petplanner.petplanner.DAO.AliDAO;
...
@Database(entities = {Pet.class, Users.class, Urina.class, Humor.class, Atividade.class, Fezes.class, Alimentacao.class, Agua.class},version = 1)
